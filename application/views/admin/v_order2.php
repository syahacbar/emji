						...
						<div class="row">
							...
							?>
								<tr>
                                    ...
                                    <td><?php $query=$this->db->query("SELECT * FROM tbl_detail td, tbl_menu tm, tbl_stand ts, tbl_pengguna tp WHERE tm.menu_stand_id=ts.stand_id AND td.detail_menu_id=tm.menu_id AND tp.pengguna_id=ts.stand_pengguna_id AND detail_inv_no='$id' AND tp.pengguna_id='$idpengguna'"); ?>
                                                        <ul>
                                                        <?php
                                                        foreach ($query->result_array() as $j) {
                                                            ...
                                                            echo "<li>".$menu_nama.": ".$menu_porsi." porsi</li>";
                                                        } ?>
                                                        </ul>
                                    </td>
